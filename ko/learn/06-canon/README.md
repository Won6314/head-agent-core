...
[HEAD Agent Core](../../README.md) / [학습](../README.md) / 정본
...
이 장은 요약에 가치가 없다는 보편적 주장이 아니라 현재 공유 복구 계약을 설명합니다. 프로젝트 컨텍스트, 비공개 작업 기록, 내부 경로 또는 구현 본문을 공개하지 않습니다. 공개 참조 컨텍스트는 [공유 Core (영문)](../../../head/README.md)와 저장소 [아키텍처 개요](../../README.md)를 참조하세요.

...
[HEAD Agent Core (영문)](../../../README.md) / [학습 과정 (영문)](../../../learn/README.md) / [LLM 문제 모델](README.md) / 컨텍스트가 많다고 지능이 높아지는 것은 아니다
...
다음 학습 장: [소유권: 사용자, HEAD, 경계가 정해진 에이전트 (영문)](../../../learn/03-ownership/README.md).

[학습 과정 HEAD로 돌아가기 (영문)](../../../learn/README.md).

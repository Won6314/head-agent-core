...
```mermaid
flowchart LR
    F[Observed failure] --> D[Add prohibition]
    D --> X[More exceptions and overlap]
    F --> P[Extract durable principle]
    P --> J[Reason about a new case]
    J --> V[Verify against evidence]
```
